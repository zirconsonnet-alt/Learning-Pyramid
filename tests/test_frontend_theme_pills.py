...
def test_global_settings_pills_use_theme_tokens_instead_of_fixed_palettes() -> None:
    assert_settings_pills_use_theme_tokens(GLOBAL_SETTINGS_PAGE.read_text(encoding="utf-8"))


def test_global_settings_layout_moves_music_directory_into_access_center() -> None:

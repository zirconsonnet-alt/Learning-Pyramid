...
class RuntimeCapability(str, Enum):
    ...
    NATIVE_FS_BINDING = "NATIVE_FS_BINDING"
    LOCAL_ASR = "LOCAL_ASR"
    LOCAL_LLM_QA = "LOCAL_LLM_QA"
    LOCAL_RECOMMENDER = "LOCAL_RECOMMENDER"
    MEMORY_CANVAS_EDIT = "MEMORY_CANVAS_EDIT"
    STORY_GENERATION = "STORY_GENERATION"


class CandidateRecallPointState(str, Enum):
    PENDING = "PENDING"
    ACCEPTED = "ACCEPTED"
    REJECTED = "REJECTED"
...
class AuditEventKind(str, Enum):
    ...
    BIND_NATIVE_LOCAL_ROOT = "BIND_NATIVE_LOCAL_ROOT"
    ...
    REQUEST_LOCAL_LLM = "REQUEST_LOCAL_LLM"
    CREATE_QA_SESSION = "CREATE_QA_SESSION"
    GENERATE_CANDIDATE_RECALL_POINT = "GENERATE_CANDIDATE_RECALL_POINT"

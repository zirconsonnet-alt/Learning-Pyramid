...
POSTGRES_MIGRATIONS: tuple[PostgresMigration, ...] = (
    ...
    PostgresMigration(
        scope="auth",
        version=2,
        name="desktop_agent_auth_tables",
        sql_factory=lambda: "\n".join(
            (
    ...
    PostgresMigration(
        ...
        sql_factory=lambda: "\n".join(
            (
                ...
                "    agent_id TEXT NOT NULL REFERENCES desktop_agents(agent_id) ON DELETE CASCADE,",
                "    user_id TEXT NOT NULL REFERENCES users(user_id) ON DELETE CASCADE,",
                "    mode TEXT NOT NULL,",
                "    status TEXT NOT NULL,",
                "    range_start BIGINT NULL,",
                "    range_end BIGINT NULL,",
                "    bytes_from_agent BIGINT NOT NULL,",
                "    bytes_to_viewer BIGINT NOT NULL,",
                "    created_at TEXT NOT NULL,",
    ...
    PostgresMigration(
        scope="auth",
        version=4,
        name="desktop_media_probe_cache",
        sql_factory=lambda: "\n".join(
            (
    ...
    PostgresMigration(
        scope="auth",
        version=6,
        name="desktop_agent_hls_job_audits",
        sql_factory=lambda: "\n".join(
            (
    ...
    PostgresMigration(
        scope="auth",
        version=7,
        name="desktop_agent_metric_samples",
        sql_factory=lambda: "\n".join(
            (
                ...
                "    active_stream_count BIGINT NOT NULL,",
                "    completed_stream_count BIGINT NOT NULL,",
                "    failed_stream_count BIGINT NOT NULL,",
                "    cancelled_stream_count BIGINT NOT NULL,",
                "    bytes_from_agent_total BIGINT NOT NULL,",
                "    bytes_to_viewer_total BIGINT NOT NULL,",
                "    hls_job_count BIGINT NOT NULL,",
                "    active_hls_job_count BIGINT NOT NULL,",
                "    completed_hls_job_count BIGINT NOT NULL,",
                "    failed_hls_job_count BIGINT NOT NULL,",
                "    cancelled_hls_job_count BIGINT NOT NULL,",
                "    hls_artifact_bytes_total BIGINT NOT NULL,",
                "    hls_cache_entry_count BIGINT NOT NULL,",
                "    hls_cache_bytes BIGINT NOT NULL,",
    ...
    PostgresMigration(
        scope="auth",
        version=8,
        name="desktop_agent_diagnostic_events",
        sql_factory=lambda: "\n".join(
            (
    ...
    PostgresMigration(
        scope="auth",
        version=9,
        name="desktop_media_probe_cache_extended_metadata",
        sql_factory=lambda: "\n".join(
            (
                "ALTER TABLE desktop_media_probe_cache ADD COLUMN IF NOT EXISTS fps DOUBLE PRECISION NULL;",
                "ALTER TABLE desktop_media_probe_cache ADD COLUMN IF NOT EXISTS audio_channels BIGINT NULL;",
                "ALTER TABLE desktop_media_probe_cache ADD COLUMN IF NOT EXISTS audio_sample_rate BIGINT NULL;",
                "ALTER TABLE desktop_media_probe_cache ADD COLUMN IF NOT EXISTS video_stream_count BIGINT NULL;",
                "ALTER TABLE desktop_media_probe_cache ADD COLUMN IF NOT EXISTS audio_stream_count BIGINT NULL;",
                "ALTER TABLE desktop_media_probe_cache ADD COLUMN IF NOT EXISTS subtitle_stream_count BIGINT NULL;",
                "ALTER TABLE desktop_media_probe_cache ADD COLUMN IF NOT EXISTS size_bytes BIGINT NULL;",
                "ALTER TABLE desktop_media_probe_cache ADD COLUMN IF NOT EXISTS modified_at TEXT NULL;",
            )
        ),
    ),
    PostgresMigration(
        scope="auth",
        version=10,
        name="desktop_agent_hls_job_audits_cache_key_index",
        sql_factory=lambda: "\n".join(
            (
